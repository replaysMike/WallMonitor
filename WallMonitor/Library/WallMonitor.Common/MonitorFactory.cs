...
namespace WallMonitor.Common
{
    ...
    {
        private static readonly Lazy<Assembly> MonitorAssembly = new (() => Assembly.Load("WallMonitor.Monitors"));
        ...
        public static IMonitorAsync Create(IServiceScope scope, string name, int monitorId)
        {
            ...
            var type = MonitorAssembly.Value.GetType($"WallMonitor.Monitors.{name.Replace("MonitorAsync", "", StringComparison.InvariantCultureIgnoreCase)}MonitorAsync", false, true);
