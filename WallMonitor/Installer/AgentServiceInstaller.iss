#define MyAppName "Wall Monitor Agent"
...
#define MyAppExeName "WallMonitor.Agent.exe"
...
LicenseFile=..\..\LICENSE
OutputDir=.\
OutputBaseFilename=WallMonitor-Agent-win10x64-{#MyAppVersion}
