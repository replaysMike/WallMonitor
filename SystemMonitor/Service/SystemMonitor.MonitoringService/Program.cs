...
using SystemMonitor.Common.Notifications;
using SystemMonitor.Licensing;
using SystemMonitor.MonitoringService;
    ...
    using var host = Host.CreateDefaultBuilder(args)
        ...
        .ConfigureServices(services =>
        {
            ...
            try
            {
                ...
                logger.Info($"Loaded {monitorTypes.Count} IMonitorAsync implementations in assembly 'SystemMonitor.Monitors'.");
            }
            catch (Exception ex)
            {
                logger.Error(ex, "Failed to load IMonitorAsync implementations from assembly 'SystemMonitor.Monitors'");
            }
