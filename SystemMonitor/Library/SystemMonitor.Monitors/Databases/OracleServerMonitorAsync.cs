...
namespace SystemMonitor.Monitors
{
    ...
    public class OracleServerMonitorAsync : IMonitorAsync
    {
        ...
        public string ServiceDescription => "Monitors Oracle database with optional query execution.";
        ...
        public OracleServerMonitorAsync(ILogger logger)
        {
            _logger = logger;
        }
        ...
        public async Task<IHostResponse> CheckHostAsync(IHost host, IConfigurationParameters parameters, System.Threading.CancellationToken cancelToken)
        {
            ...
            {
                response.IsUp = false;
                _logger.LogError(ex, $"Exception thrown in  '{nameof(OracleServerMonitorAsync)}'");
            }
