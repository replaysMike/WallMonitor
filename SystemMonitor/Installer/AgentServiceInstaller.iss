...
#define MyAppDescription "Provides access to hardware and resources for remote monitoring"
#define MyAppVersion "0.0"
#define MyAppPublisher "System Monitor"
#define MyAppURL "https://github.com/replaysMike/SystemMonitor/"
#define MyAppExeName "SystemMonitor.Agent.exe"

[Setup]
AppId={{14641163-DA03-41D2-BD41-CA8C13F57BB6}
AppName={#MyAppName}
...
LicenseFile=..\..\LICENSE
OutputDir=.\
OutputBaseFilename=SystemMonitor-Agent-win10x64-{#MyAppVersion}
...
WizardImageFile=.\Agent-WizardLarge.bmp
WizardSmallImageFile=.\Agent-WizardSmall.bmp
...
[Messages]
WelcomeLabel2=The System Monitor Agent provides access to hardware and resources on this computer for reporting purposes.%n%nMonitoring services can connect to this agent to query it's data.%n%nThis will install [name/ver] on your computer.
