...
#define MyAppExeName "SystemMonitor.MonitoringService.exe"
...
LicenseFile=..\..\LICENSE
OutputDir=.\
OutputBaseFilename=SystemMonitor-MonitoringService-win10x64-{#MyAppVersion}
